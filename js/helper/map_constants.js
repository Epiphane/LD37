define([
   ...
   MapConstants.setTheme = function(index) {
      var yoff = index * 128;
      ...
      uvSquare(wallGeometry, LEFT,   texture_size, texture_size, 96,  0,  128, 128);
      ...
      uvSquare(wallBroken1Geometry, FRONT,  texture_size, texture_size, off+0,   32,  off+32, 128);
      uvSquare(wallBroken1Geometry, RIGHT,  texture_size, texture_size, off+32,  32,  off+64, 128);
      uvSquare(wallBroken1Geometry, BACK,   texture_size, texture_size, off+64,  32,  off+96, 128);
      uvSquare(wallBroken1Geometry, LEFT,   texture_size, texture_size, off+96,  32,  off+128,128);
      ...
      uvSquare(wallBroken2Geometry, LEFT,   texture_size, texture_size, off+96,  0,  off+128, 128);
